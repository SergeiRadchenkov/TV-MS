...
print(bartlett(pu_238, pu_239, pu_240, pu_241))

print(stats.kruskal(pu_238, pu_239, pu_240, pu_241))
print(stats.f_oneway(pu_238, pu_239, pu_240, pu_241))

print(str(np.std(pu_238)) + ' ' + str(np.std(pu_239)) + ' ' + str(np.std(pu_240)) + ' ' + str(np.std(pu_239)))
print(str(np.mean(pu_238)) + ' ' + str(np.mean(pu_239)) + ' ' + str(np.mean(pu_240)) + ' ' + str(np.mean(pu_239)))
print(str(np.median(pu_238)) + ' ' + str(np.median(pu_239)) + ' ' + str(np.median(pu_240)) + ' ' + str(np.median(pu_239)))
